	...
	<div style="width: 100%; margin: 0px; padding: 0px; background: url(image/top-navigation-background.jpg) repeat-x;">
	 <div style="float:left;width:83%;height:35px;">
		<ul	style="margin: 0px; padding: 0px; height: 35px; list-style-type: none;width:600px;">
			<li class="title">
				<a href="teacher_left.jsp" target="leftFrame">项目管理</a>
			</li>
			<li class="title">
				<a href="teacher_left_user.jsp" target="leftFrame">用户管理</a>
			</li>
		<li class="title">
				<a href="teacher_left_data.jsp" target="leftFrame">数据统计</a>
			</li>
		<li class="title">
				<a href="teacher_left_msg.jsp" target="leftFrame">公告通知</a>
			</li>
			<li class="title">
		...
		<div style=" float:left;width:13%;height:35px;">
		<p style="line-height:34px;">用户名：徐凯     身份：管理员</p>&nbsp;&nbsp;
